        ...
        var header = $(document.createElement('div')).addClass('x_title').append(
            ...
            $(document.createElement('ul')).addClass('nav navbar-right panel_toolbox').append(
                $(document.createElement('li')).append(
                    $(document.createElement('a')).attr('href', "javascript:;").addClass('collapse-link').data(settings).data('open', (settings.open ? ' data-open="'+settings.open+'"' : '' )).data('open', (settings.close ? ' data-open="'+settings.close+'"' : '' )).append(
